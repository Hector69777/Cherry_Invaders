...
color_blanco = (255, 255, 255) # Color blanco de las fuentes de texto
pygame.init()
	...
	def ejecutar(self, escena_inicial, fps = 60):
		...
		while jugando:
			...
			for evento in eventos:
			    # Si se presiona la tachita de l barra de título,
			...
			self.elegirEscena(self.escena.jugando)
...
class EscenaNivel():
    ...
    def dibujar(self, pantalla):
	    ...
	    # Funcion de puntuacion en pantalla
...
class EscenaJuegoTerminado(Escena):
	...
	def dibujar(self, pantalla):
		...
		texto = fuente.render('Juego terminado subnormal', True, color_blanco)
		texto_rect = texto.get_rect()
...
class Bolita(pygame.sprite.Sprite):
    def __init__(self):
        ...
        # Cargar imagen
        self.image = pygame.image.load('ladrillos/imagenes/emoji_bola.png')
...
class Paleta(pygame.sprite.Sprite):
    def __init__(self):
        pygame.sprite.Sprite.__init__(self)
        # Cargar imagen
        self.image = pygame.image.load('ladrillos/imagenes/hueso.png')
        # Obtener rectángulo de la imagen
        self.rect = self.image.get_rect()
...
class Ladrillo(pygame.sprite.Sprite):
    def __init__(self, posicion):
        pygame.sprite.Sprite.__init__(self)
        # Cargar imagen
        self.image = pygame.image.load('ladrillos/imagenes/ladrillote.png')
        # Obtener rectángulo de la imagen
        self.rect = self.image.get_rect()
